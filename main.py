...
class cipherInterface:
    def __init__(self, master) -> None:
        ...
        Functions = cipherFunctions(self.nonKeyCiphers)
        ...
        encryptButton = Elements.button(topFrame, 'right', 'Encrypt','h2',lambda:Functions.encrypt(self.Cipher.get(),self.inputVar.get(), self.keyVar.get()))
        decryptButton = Elements.button(topFrame, 'right', 'Decrypt','h2',lambda:Functions.encrypt(self.Cipher.get(),self.inputVar.get(), self.keyVar.get()))
